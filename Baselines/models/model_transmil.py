'''
Code taken from https://github.com/szc19990412/HVTSurv/blob/main/models/TransMIL.py and slightly modified for this codebase
'''
...
class TransMIL_peg(nn.Module):
    def __init__(self, n_classes):
        ...
        # self.layer3 = TransLayer(dim=128)
    ...
    def forward(self, return_attn=False, **kwargs):
        ...
        h = kwargs['x_path'].float().unsqueeze(0) #[B, n, 768]
        ...
        if return_attn:
            ...
            # h, attn_vals = self.layer3(h,return_attn) #[B, N, 128]
        else:
            h = self.layer2(h)
            # h = self.layer3(h)
        ...
        if return_attn:
            return hazards, S, Y_hat, None, None, attn_vals
        else:
